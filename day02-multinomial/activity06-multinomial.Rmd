...
ggplot(summary_df, aes(x = count, y = income_cat, fill = voter_category)) +
  geom_bar(stat = "identity", position = "stack") +
  scale_fill_brewer(palette = "Set2") +  # Applying a RColorBrewer palette
  theme_minimal() +
  labs(title = "Count of Voter Categories by Age Group",
       x = "Count",
       y = "Income Category") +
  theme_minimal() +
...
```{r demographic viz}
ggplot(nonvoters, aes(x = race, y=ppage, fill = voter_category)) +
  geom_bar(stat = "identity", position = "stack")
```
